#!/usr/bin/env bash
# Run all filters on cuuic sensor model IN PARALLEL.
# Usage: bash run_cubic_sensor_filters.sh [MAX_PARALLEL]
...
EXPERIMENTS=(
    cubic_sensor/cubic_sensor_ekf
    cubic_sensor/cubic_sensor_kf
    cubic_sensor/cubic_sensor_pf_ot
    cubic_sensor/cubic_sensor_pf_soft
    cubic_sensor/cubic_sensor_pf_sys
    cubic_sensor/cubic_sensor_ukf
)
