#!/usr/bin/env bash
# Run all filters on lorenz96 model IN PARALLEL.
# Usage: bash run_lorenz96_filters.sh [MAX_PARALLEL]
...
EXPERIMENTS=(
    lorenz96/lorenz96_kernel_matrix
    lorenz96/lorenz96_kernel_scalar
)
