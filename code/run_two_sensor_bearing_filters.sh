#!/usr/bin/env bash
# Run all filters on two sensor uearing model IN PARALLEL.
# Usage: bash run_two_sensor_bearing_filters.sh [MAX_PARALLEL]
...
EXPERIMENTS=(
    two_sensor_bearing/two_sensor_bearing_mc_linear
    two_sensor_bearing/two_sensor_bearing_mc_optimal
)
