"""Gradient validation: LEDH+OT approximate Sinkhorn backward on LG."""
...
from src.filters.particle import ledh_invertible_hmc as ledh_hmc
from src.models.linear_gaussian import LinearGaussianModel
from src.models.utils import generate_data
from src.resampling.ot_entropy_approx import ot_entropy_resample as ot_resample

from _gradient_test_utils import TOL_LG, gradient_case, reset_results

LEDHParticleFlowFilterHMC = ledh_hmc.LEDHParticleFlowFilterHMC
...
def _force_approx_backward(monkeypatch):
    monkeypatch.setattr(ledh_hmc, "ot_entropy_resample", ot_resample)
    yield
