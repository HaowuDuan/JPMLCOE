...
\subsection{Derivations}\label{sec:kalman_derivations}
...
\subsection{Numerical Stability: Joseph Form}
...
\subsection{Failure on Nonlinear Models}
...
\subsubsection{Particle Degeneracy}
...
% Content to be expanded. See invertible particle flow rows in the EDH/LEDH comparison tables above.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\section{HMC and Differentiable Particle Filters}

\subsection{HMC Theory and Literature Review}
...
\subsubsection{PMCMC: Gradient-Free Baseline}
...
\subsubsection{SGD-Based Parameter Estimation}
...
\subsubsection{The Differentiability-Bias Trade-off}
...
\subsubsection{Workflow and Current Status}
